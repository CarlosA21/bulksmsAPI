...
keytool -genkeypair -alias bulksmsapi -keyalg RSA -keysize 2048 -storetype PKCS12 -keystore src\main\resources\keystore.p12 -validity 365 -dname "CN=localhost, OU=BulkSMS, O=BulkSMS API, L=City, S=State, C=US" -storepass changeit
